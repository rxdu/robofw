...
/*3000 */
        #define OD_3000_speedFeedback                               0x3000

        #define OD_3000_0_speedFeedback_maxSubIndex                 0
        #define OD_3000_1_speedFeedback_rpm_left                    1
        #define OD_3000_2_speedFeedback_rpm_right                   2

/*3001 */
        #define OD_3001_encoderFeedback                             0x3001

        #define OD_3001_0_encoderFeedback_maxSubIndex               0
        #define OD_3001_1_encoderFeedback_encoder_left              1
        #define OD_3001_2_encoderFeedback_encoder_right             2
...
/*3000      */ INTEGER32       speedFeedback[2];
/*3001      */ INTEGER32       encoderFeedback[2];
...
/*3000, Data Type: INTEGER32, Array[2] */
        #define OD_speedFeedback                                    CO_OD_RAM.speedFeedback
        #define ODL_speedFeedback_arrayLength                       2
        #define ODA_speedFeedback_rpm_left                          0
        #define ODA_speedFeedback_rpm_right                         1

/*3001, Data Type: INTEGER32, Array[2] */
        #define OD_encoderFeedback                                  CO_OD_RAM.encoderFeedback
        #define ODL_encoderFeedback_arrayLength                     2
        #define ODA_encoderFeedback_encoder_left                    0
        #define ODA_encoderFeedback_encoder_right                   1
